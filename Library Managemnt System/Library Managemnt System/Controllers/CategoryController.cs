            ...
            if (result.name != null)
            {
                ...
                if (name is not null)
                {
                    ...
                    foreach (var book in books)
                    {
                        ...
                        {
                            if (dicOfBooks.ContainsKey(book.Category.Name.ToLower() ) == true)
                            {
                    ...
                    foreach (var category in categoryModel)
                    {
                        if ((dicOfBooks.ContainsKey(category.Name.ToLower()) == true || category.Name.ToLower().Contains(name)) == true && flag[category.Name.ToLower()] == true)
                        {
